...
export default function BudgetTransactionsPage() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-left">Mes dépenses</h1>
      ...
      <form onSubmit={handleSubmit} className="mt-4 p-4 bg-gray-100 dark:bg-neutral-800 rounded-lg">
        <p className="pb-2 font-semibold">Ajouter une dépense</p>
        <input
          type="text"
          name="description"
      ...
      <table className="mt-4 w-full border-collapse border border-gray-300 dark:border-neutral-700">
        ...
        <tbody>
          {transactions.map((t) => (
            ...
            >
              <td className="text-center p-2 border border-black dark:border-neutral-700">{t.description}</td>
              <td className="text-center p-2 border border-black dark:border-neutral-700">{t.amount}</td>
              <td className="text-center p-2 border border-black dark:border-neutral-700">{t.category}</td>
              <td className="text-center p-2 border border-black dark:border-neutral-700">{new Date(t.date).toLocaleDateString()}</td>
